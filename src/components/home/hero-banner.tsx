      ...
      {SLIDES.map((slide, index) => (
        ...
        >
          ...
          <div className="absolute inset-0 opacity-30">
            <div className={cn("absolute left-1/4 top-1/4 h-64 w-64 rounded-full blur-3xl", slide.decorative1)} />
            <div className={cn("absolute bottom-1/4 right-1/4 h-96 w-96 rounded-full blur-3xl", slide.decorative2)} />
          </div>
